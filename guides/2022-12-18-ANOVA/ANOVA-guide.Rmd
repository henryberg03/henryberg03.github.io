...
## Load Packages; if missing, install them
load.lib<-c("tidyverse","bestNormalize","agricolae","nlme","multcomp","beepr") # List of required packages
...
Run post-hoc test if interaction is significant
```{r}
tx <- with(dat_stat, interaction(timepoint,treatment,ploidy))
